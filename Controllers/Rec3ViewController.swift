...
public class Rec3ViewController: UIViewController {
    ...
    @IBAction func lap(_ sender: UIButton) {
        ...
        let pathToSound = Bundle.main.path(forResource: "chill01_E", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap2(_ sender: UIButton) {
        ...
        //SOUND BUTTON 2
        let pathToSound = Bundle.main.path(forResource: "chill02_F", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap3(_ sender: Any) {
        ...
        let pathToSound = Bundle.main.path(forResource: "chill03_F", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap4(_ sender: Any) {
        let pathToSound = Bundle.main.path(forResource: "chill04_G", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap5(_ sender: Any) {
        let pathToSound = Bundle.main.path(forResource: "chill05_A", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap6(_ sender: Any) {
        let pathToSound = Bundle.main.path(forResource: "chill06_A", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
...
extension Rec3ViewController: UITableViewDelegate,UITableViewDataSource{
