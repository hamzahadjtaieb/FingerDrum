...
public class Rec2ViewController: UIViewController {
    ...
    @IBAction func lap(_ sender: UIButton) {
        ...
        let pathToSound = Bundle.main.path(forResource: "TR606-Cym", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap2(_ sender: UIButton) {
        ...
        //SOUND BUTTON 2
        let pathToSound = Bundle.main.path(forResource: "TR606-Hat", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap3(_ sender: Any) {
        ...
        let pathToSound = Bundle.main.path(forResource: "TR606-HiH", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap4(_ sender: Any) {
        let pathToSound = Bundle.main.path(forResource: "TR606-Kic", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap5(_ sender: Any) {
        let pathToSound = Bundle.main.path(forResource: "TR606-Tom", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
    ...
    @IBAction func lap6(_ sender: Any) {
        let pathToSound = Bundle.main.path(forResource: "TR606-Snr", ofType: "wav")!
        let url = URL(fileURLWithPath: pathToSound)
        print(url)
...
extension Rec2ViewController: UITableViewDelegate,UITableViewDataSource{
